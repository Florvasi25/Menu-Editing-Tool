...
"}")
        ...
        self.pushButton = QPushButton(self.parseJson)
...
"border-radius: 5px")
        ...
        self.menubar.setGeometry(QRect(0, 0, 937, 34))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(QCoreApplication.translate("MainWindow", u"Taxable Yes", None))
